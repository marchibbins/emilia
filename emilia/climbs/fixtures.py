    ...
    fixtures = [
        {
            ...
            'climbs': [
                (1, "cheddar-gorge", "Cheddar Gorge", "Cheddar, Somerset", 944629),
                (2, "weston-hill", "Weston Hill", "Weston, Bath", 944629),
                (3, "crowcombe-combe", "Crowcombe Combe", "Crowcombe, Somerset", 944629),
            ]
        },
        {
            'book': ("another",
            ...
            'climbs': [
                (101, "gold-hill", "Gold Hill", "Shaftesbury, Dorset", 944629),
                (102, "zig-zag-hill", "Zig Zag Hill", "Shaftesbury, Dorset", 944629),
                (103, "park-hill", "Park Hill", "Longleat, Dorset", 944629),
            ]
        },
    ]
